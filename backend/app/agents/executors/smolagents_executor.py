# from https://github.com/huggingface/smolagents/blob/main/src/smolagents/local_python_executor.py
import ast
import builtins
import difflib
import inspect
...
def evaluate_call(
    ...
    if func_name == "super":
        ...
        if (
            ...
            raise InterpreterError(
                f"Forbidden call to dunder function: {func.__name__}"
            )
